...
const benefits = [
  {id: 1, logo: dollar, title: 'Прибыльность', description: 'Благодаря вероятностному подходу, расширение увеличивает показатель выигрышных партий до 80%.'},
  ...
  {id: 3, logo: lock, title: 'Открытый код', description: 'Принцип работы нашего кода находится в открытом доступе. Каждый может убедиться в его работоспособности.'},
]
